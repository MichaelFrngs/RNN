...
os.chdir("C:/Users/mfrangos/Desktop/2020 Forecast Recurrent Neural Net")
...
for column in df.columns[113:]:
  #print(Data_column_label_i)
  Data_column_label = Data_column_label_i
    
 
  
  Y_axis_output = df.loc[:,Data_column_label].as_matrix()
  train_data = Y_axis_output
  #eliminate nan
  ...
  n_predict_once = 52 # Number of steps you continously predict for. #Number of predictions
...
#        lowest_loss_epoch = 
  ...
  plt.ylabel('Y_axis_output',fontsize=18)
  plt.xlim(0,len(train_data+70))
  ...
  plt.ylabel('Y_axis_output',fontsize=18)
  plt.xlim(0,len(train_data+70))
  plt.savefig(f"{Data_column_label}")
  plt.show()
  ...
  export_prediction.to_excel(f"Data_column_label {Data_column_label}.xlsx")
